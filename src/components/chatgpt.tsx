...
import { PlusIcon, PaperclipIcon, SparklesIcon, ShoppingBagIcon, WandIcon, MousePointerIcon, MoreHorizontalIcon, ShareIcon, BookOpenIcon, GlobeIcon, PenToolIcon, AudioLinesIcon, ArrowUpIcon, ChevronDownIcon, SettingsIcon, FolderIcon, CircleCheckIcon, LightbulbIcon } from "lucide-react"
